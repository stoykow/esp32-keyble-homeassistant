...
// CONFIGURATION
// -----------------------------------------------------------------------------
// Die Datei "secrets.h" wird verwendet, um sensible Informationen wie MQTT-Host,
// Benutzername, Passwort und andere Zugangsdaten zu speichern. 
// Diese Datei wird nicht im öffentlichen Repository geteilt, um die Sicherheit zu gewährleisten.
// Erstellen Sie bitte eine eigene "secrets.h"-Datei mit Ihren eigenen Zugangsdaten,
// basierend auf der bereitgestellten Vorlage (z.B. "secrets_example.h").
#include "secrets.h"

// MQTT configuration
// Der MQTT-Port wird nicht als sensibel betrachtet und bleibt im Code.
// Sie können diesen Wert nach Bedarf ändern, um den richtigen Port für Ihre MQTT-Verbindung zu verwenden.
#define MQTT_PORT 1883

// USER_ID wird verwendet, um den Benutzer für die Keyble-Verbindung zu identifizieren.
// Sie können diesen Wert anpassen, falls erforderlich.
#define USER_ID 0 // Ändern Sie diesen Wert entsprechend Ihrer Konfiguration
